/**
 * popup/ZzimRemoveInfoPopup
 */
W.defineModule(["comp/PopupButton"], function(buttonComp) {
	'use strict';
	W.log.info("ZzimRemoveInfoPopup");
	var _this;
	var _comp;
	var index;
	var desc;
	...
	function create(){
		_comp.add(new W.Span({x:449-419, y:248-219, width:"383px", height:"38px", textColor:"rgb(237,168,2)", "font-size":"34px", 
			className:"font_rixhead_medium", text:W.Texts["popup_zzim_remove_info_title"], textAlign:"center"}));
		_comp.add(new W.Div({x:449-419, y:304-219, width:"383px", height:"1px", backgroundColor:"rgba(255,255,255,0.07)"}));	
		var guide = W.Texts["popup_zzim_remove_info_guide1"].split("^");
		...
		_comp.add(new W.Span({x:433-403, y:336-219 + 48, width:"415px", height:"20px", textColor:"rgb(255,255,255)", "font-size":"18px", 
			className:"font_rixhead_medium", text:W.Texts["popup_zzim_remove_info_guide2"], textAlign:"center"}));
		
		_comp.btns = [];
		_comp.btns[0] = buttonComp.create(504-419, 441-219, W.Texts["delete"], 133);
		_comp.btns[1] = buttonComp.create(645-419, 441-219, W.Texts["close"], 133);
    ...
    return W.Popup.extend({
    	onStart: function(_param) {
    		W.log.info("ZzimRemoveInfoPopup onStart");
    		desc = _param.desc;
    		_this = this;
    	...
    	onStop: function() {
    		W.log.info("ZzimRemoveInfoPopup onStop");
    	},
    	onKeyPressed : function(event) {
    		W.log.info("ZzimRemoveInfoPopup onKeyPressed "+event.keyCode);
