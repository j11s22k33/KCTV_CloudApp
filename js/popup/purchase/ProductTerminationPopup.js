...
W.defineModule(["comp/PopupButton", "mod/Util"], function(buttonComp, util) {
	...
	function create(){
		_comp.add(new W.Span({x:448-418, y:222-194, width:"384px", height:"38px", textColor:"rgb(237,168,2)", "font-size":"34px", 
			className:"font_rixhead_medium", text:W.Texts["popup_product_termination_title"], textAlign:"center"}));

		_comp.add(new W.Div({x:448-418, y:279-194, width:"384px", height:"1px", backgroundColor:"rgba(255,255,255,0.07)"}));

		_comp.add(new W.Span({x:448-418, y:308-194, width:"384px", height:"20px", textColor:"rgb(255,255,255)", "font-size":"18px", 
			className:"font_rixhead_medium", text:W.Texts["popup_product_termination_guide1"], textAlign:"center"}));
		_comp.add(new W.Span({x:448-418, y:308-194 + 24, width:"384px", height:"20px", textColor:"rgb(255,255,255)", "font-size":"18px", 
			className:"font_rixhead_medium", text:W.Texts["popup_product_termination_guide2"], textAlign:"center"}));
		...
		_comp.btns = [];
		_comp._btns = [];
		_comp.btns[0] = buttonComp.create(503-418, 466-194, W.Texts["delete"], 133);
    ...
    return W.Popup.extend({
    	...
    	onStop: function() {
    		W.log.info("ProductTerminationPopup onStop");
			W.CloudManager.delNumericKey();
    	},
    	onKeyPressed : function(event) {
    		W.log.info("ProductTerminationPopup onKeyPressed "+event.keyCode);
