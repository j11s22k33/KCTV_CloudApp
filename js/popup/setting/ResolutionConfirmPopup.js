...
W.defineModule(["mod/Util", "comp/PopupButton"], function(util, buttonComp) {
	...
	function create(){
		...
		_comp._textArea = new W.Div({x:390, y:292, width:500, height:160, display:"-webkit-flex", "-webkit-flex-direction":"column", "-webkit-align-items":"center","-webkit-justify-content":"center"});

		var textL = "";
		if(type == "1080P") {
			textL = W.Texts["popup_resolution_confirm_title1"];

			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide1"], textColor:"rgba(255,255,255,1)", fontFamily:"RixHeadM", "font-size":"18px", textAlign:"center", "letter-spacing":"-0.9px"}));
			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide2"], textColor:"rgba(255,255,255,1)", fontFamily:"RixHeadM", "font-size":"18px", textAlign:"center", "letter-spacing":"-0.9px"}));
			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide3"], textColor:"rgba(255,255,255,1)", fontFamily:"RixHeadM", "font-size":"18px", textAlign:"center", "letter-spacing":"-0.9px"}));

		} else if(type == "UHD") {
			textL = W.Texts["popup_resolution_confirm_title2"];
			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide4"], textColor:"rgba(255,255,255,1)", fontFamily:"RixHeadM", "font-size":"18px", textAlign:"center", "letter-spacing":"-0.9px"}));
			_comp._textArea.add(new W.Div({position:"relative", height:24+15, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide3"], textColor:"rgba(255,255,255,1)", fontFamily:"RixHeadM", "font-size":"18px", textAlign:"center", "letter-spacing":"-0.9px"}));
			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide5"], textColor:"rgba(181,181,181,0.75)", fontFamily:"RixHeadL", "font-size":"16px", textAlign:"center", "letter-spacing":"-0.8px"}));
			_comp._textArea.add(new W.Div({position:"relative", height:24, "white-space":"pre-line", width:"500px", text:W.Texts["popup_resolution_confirm_guide6"], textColor:"rgba(181,181,181,0.75)", fontFamily:"RixHeadL", "font-size":"16px", textAlign:"center", "letter-spacing":"-0.8px"}));
		}

		_comp.add(_comp._textArea);


		_comp._countArea = new W.Div({x:390, y:292, width:500, height:95, display:"none", "-webkit-flex-direction":"column", "-webkit-align-items":"center","-webkit-justify-content":"center"});
	...
	function setCount() {
		isCount = true;
		_comp._title.setText(W.Texts["popup_resolution_confirm_title3"]);
		_comp._countArea._progress.setStyle({width:395});
		_comp._countArea._count.setText("10" + W.Texts["second"]);
		_comp._countArea.setStyle({display:"-webkit-flex"});
		_comp._textArea.setStyle({display:"none"});
		countIdx = 10;
