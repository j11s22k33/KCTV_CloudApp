 ...
 */
W.defineModule([ "mod/Util", "comp/home/AppList", "comp/RightTimer"],
    function(util, appList, rightTimer) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                currComponent = appList.getNewComp();
                _currComponent = currComponent.create(_parentDiv, _this, {category: param.category});
