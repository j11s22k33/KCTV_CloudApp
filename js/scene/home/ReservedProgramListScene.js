/**
 * scene/ReservdProgramListScene
 *
 * [Flipbook] 3.1.1
 *
 * Author : jean511@alticast.com
 */
W.defineModule([ "mod/Util", "comp/guide/ReservedProgramList", "comp/CouponInfo"],
    function(util, reservedProgramList, couponInfoComp) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        var _thisScene = "ReservdProgramListScene";
        var _this;
        var _parentDiv;
        var currMenu;
        var currComponent;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                currComponent = reservedProgramList.getNewComp();
                _currComponent = currComponent.create(_parentDiv, _this, {isLooping : true, mode : 2});
