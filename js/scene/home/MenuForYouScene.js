/**
 * scene/MenuForyouScene
 *
 * [Flipbook] 3.1.1
 *
 * Author : jean511@alticast.com
 */
W.defineModule([ "mod/Util", "comp/home/MenuForyou", "comp/CouponInfo"],
    function(util, menuForyou, couponInfoComp) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        var _thisScene = "MenuForyouScene";
        var _this;
        var _parentDiv;
        var currMenu;
        var currComponent;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                currComponent = menuForyou.getNewComp();
                var dataObj = {};
                dataObj.categoryCode = param.category.categoryCode;
                dataObj.baseId = param.category.baseId;
                dataObj.isClearPin = param.isClearPin;
                
                _currComponent = currComponent.create(_parentDiv, _this, dataObj);
