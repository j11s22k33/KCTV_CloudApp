 ...
 */
W.defineModule([ "mod/Util", "comp/kids/KidsHome"],
    function(util, kidsHome) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                //this._parentDiv._bg = new W.Div({x:0, y:0, width:1280, height:720, color:"#000000", opacity:0.84});
                ...
                this.currComponent = kidsHome.getNewComp();
                
                if(param){
                	W.log.info(param);
    				this._currComponent = this.currComponent.create(undefined, param.category, this);
			...
			setCategoryData: function(data){
				W.log.info(data);
				this._currComponent = this.currComponent.create(undefined, data, this);
                this._parentDiv._comp_area.add(this._currComponent);
