/**
 * scene/ScheduleForyouScene
 *
 * [Flipbook] 3.1.1
 *
 * Author : jean511@alticast.com
 */
W.defineModule([ "mod/Util", "comp/guide/ScheduleForyou", "comp/CouponInfo"],
    function(util, scheduleForyou, couponInfoComp) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        var _thisScene = "ScheduleForyouScene";
        var _this;
        var _parentDiv;
        var currMenu;
        var currComponent;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                currComponent = scheduleForyou.getNewComp();
                _currComponent = currComponent.create(_parentDiv, _this, param.category.categoryCode);
