/**
 * scene/LiveTriggerDownScene
 *
 * [Flipbook] 3.1.1
 *
 * Author : jean511@alticast.com
 */
W.defineModule([ "mod/Util", "comp/liveArrow/RecommendVodList"],
    function(util, recommendVodList) {
        var STATE_TOP = 0;
        var STATE_BANNER = 1;
        var STATE_MENU = 2;
        ...
        var _thisScene = "LiveTriggerDownScene";
        var _this;
        var _parentDiv;
        var currMenu;
        var currComponent;
        ...
        return W.Scene.extend({
            onCreate : function(param) {
                ...
                currComponent = recommendVodList.getNewComp();
                _currComponent = currComponent.create(_this, {mode : 1});
                _parentDiv._comp_area.add(_currComponent);

                _this.add(_parentDiv);

                /*setTimeout(function(){
                    currComponent.changeMode(1);
                    currComponent.show();
                },500);*/
