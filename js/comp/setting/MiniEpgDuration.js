...
W.defineModule(["mod/Util", "comp/setting/Templete", "comp/setting/Button", "comp/setting/Box"], function(util, Templete, Button, Box) {
    function MiniEpgDuration() {
        ...
        var create = function(title){
            ...
            _comp._templete = _this.templete.getComp({title:title, desc:W.Texts["mini_epg_duration_guide"]});
            ...
            _this.box[1] = new Box();
            _comp._box[1] = _this.box[1].getComp({x:159, y:395, width:244, text:"3" + W.Texts["second"]});
            _comp.add(_comp._box[1]);
            _this.box[2] = new Box();
            _comp._box[2] = _this.box[2].getComp({x:159, y:465, width:244, text:"5" + W.Texts["second"]});
        ...
        this.componentName = "MiniEpgDuration";
    }
    return MiniEpgDuration;
});