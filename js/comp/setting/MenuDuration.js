...
W.defineModule(["mod/Util", "comp/setting/Templete", "comp/setting/Button", "comp/setting/Box"], function(util, Templete, Button, Box) {
    function MenuDuration() {
        ...
        var create = function(title){
            ...
            _comp._templete = _this.templete.getComp({title:title, desc:W.Texts["menu_duration_guide"]});
            ...
            _this.box[0] = new Box();
            _comp._box[0] = _this.box[0].getComp({x:159, y:325, width:244, text:"1" + W.Texts["minute"]});
            _comp.add(_comp._box[0]);
            _this.box[1] = new Box();
            _comp._box[1] = _this.box[1].getComp({x:159, y:395, width:244, text:"3" + W.Texts["minute"]});
            _comp.add(_comp._box[1]);
            _this.box[2] = new Box();
            _comp._box[2] = _this.box[2].getComp({x:159, y:465, width:244, text:"5" + W.Texts["minute"]});
            _comp.add(_comp._box[2]);
            _this.box[3] = new Box();
            _comp._box[3] = _this.box[3].getComp({x:159, y:535, width:244, text:"10" + W.Texts["minute"]});
        ...
        this.componentName = "MenuDuration";
    }
    return MenuDuration;
});