...
W.defineModule(["mod/Util", "comp/setting/Templete", "comp/setting/Button", "comp/setting/Box"], function(util, Templete, Button, Box) {
    function AudioOutput() {
        ...
        var create = function(title){
            ...
            _comp._templete = _this.templete.getComp({title:title, desc:W.Texts["audio_output_guide"]});
            ...
            _this.box[0] = new Box();
            _comp._box[0] = _this.box[0].getComp({x:159, y:345, width:244, text:W.Texts["audio_output_stereo"]});
            _comp.add(_comp._box[0]);
            _this.box[1] = new Box();
            _comp._box[1] = _this.box[1].getComp({x:159, y:415, width:244, text:W.Texts["audio_output_dolby"]});
            _comp.add(_comp._box[1]);

            _comp.add(new W.Span({x:159, y:487, width:800, text:W.Texts["audio_output_guide2"], textColor:"rgba(131,122,119,0.75)", fontFamily:"RixHeadL",
        ...
        this.componentName = "AudioOutput";
    }
    return AudioOutput;
});