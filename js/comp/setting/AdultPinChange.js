...
W.defineModule(["mod/Util", "comp/setting/Templete", "comp/setting/Button", "comp/setting/InputBox"], function(util, Templete, Button, InputBox) {
    function AdultPinChange() {
        ...
        var create = function(title){
            ...
            _comp._templete = _this.templete.getComp({title:title, desc:W.Texts["pin_change_guide"]});
            ...
            _comp._guide = new W.Div({text:W.Texts["pin_change_input_guide"], x:159, y:300, width:500, textColor:"#FFFFFF", opacity:0.75, fontFamily:"RixHeadM",
                "font-size":"20px", textAlign:"left", "letter-spacing":"-1.0px"});
            _comp.add(_comp._guide);
            _comp.add(new W.Div({text:W.Texts["pin_new_input"], x:159, y:333, width:500, textColor:"#837A77", opacity:0.75, fontFamily:"RixHeadL",
            ...
            _comp.add(new W.Div({text:W.Texts["pin_new_confirm"], x:159, y:457, width:500, textColor:"#837A77", opacity:0.75, fontFamily:"RixHeadL",
                "font-size":"18px", textAlign:"left", "letter-spacing":"-0.8px"}));
        ...
        this.componentName = "AdultPinChange";
