W.defineModule("comp/PopupButton", function(){
	...
	var Button = function(xPos, yPos, txt, width, isFocusRed, style, fontS){
		...
		_comp._unfocus.add(new W.Image({x:0, y:0, width:"20px", height:"41px", src:"img/btn_pop_l.png"}));
		_comp._unfocus.add(new W.Image({x:20, y:0, width:(width - 40) + "px", height:"41px", src:"img/btn_pop_m.png"}));
		_comp._unfocus.add(new W.Image({x:(width - 20), y:0, width:"20px", height:"41px", src:"img/btn_pop_r.png"}));
